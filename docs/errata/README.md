...
[**Errata** (68 items)](errata.md): Typos, tool user interface and behavior changes, or mistakes in code that would cause a compilation error that prevents a successful build.

[**Improvements** (47 items)](improvements.md): Changes to text or code that would improve the content. These are optional.
...
[Amar Jamal](https://github.com/amarjamal)|5|2
...
[alhi44](https://github.com/alhi44)|1|0
